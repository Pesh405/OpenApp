...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)Landroid/support/customtabs/c$a;
    .locals 1
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)Landroid/support/customtabs/c$a;
    .locals 1
    .param p1    # Landroidx/browser/customtabs/EngagementSignalsCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    .line 14
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Landroid/support/customtabs/b;Landroid/support/customtabs/a;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public isEngagementSignalsApiAvailable(Landroid/os/Bundle;)Z
    ...
    .line 4
    .line 5
    invoke-interface {v0, v1, p1}, Landroid/support/customtabs/b;->isEngagementSignalsApiAvailable(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 8
    .line 9
    invoke-interface {v0, v1, p1, p2, p3}, Landroid/support/customtabs/b;->mayLaunchUrl(Landroid/support/customtabs/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 11
    .line 12
    invoke-interface {v1, v2, p1, p2}, Landroid/support/customtabs/b;->postMessage(Landroid/support/customtabs/a;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    .line 8
    .line 9
    invoke-interface {v0, v1, p1, p2, p3}, Landroid/support/customtabs/b;->receiveFile(Landroid/support/customtabs/a;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {p2, v0, p1, p3}, Landroid/support/customtabs/b;->requestPostMessageChannelWithExtras(Landroid/support/customtabs/a;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {p2, p3, p1}, Landroid/support/customtabs/b;->requestPostMessageChannel(Landroid/support/customtabs/a;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 32
    .line 33
    invoke-interface {p2, v0, p1}, Landroid/support/customtabs/b;->updateVisuals(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)Landroid/support/customtabs/c$a;
    ...
    invoke-interface {v0, v1, p1, p2}, Landroid/support/customtabs/b;->setEngagementSignalsCallback(Landroid/support/customtabs/a;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Ljava/util/concurrent/Executor;Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 4
    invoke-direct {p0, p2, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)Landroid/support/customtabs/c$a;
    ...
    invoke-interface {p2, v0, p1, p3}, Landroid/support/customtabs/b;->setEngagementSignalsCallback(Landroid/support/customtabs/a;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 24
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/b;

    .line 25
    .line 26
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/a;

    .line 27
    .line 28
    invoke-interface {p1, p2, v0}, Landroid/support/customtabs/b;->updateVisuals(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 37
    .line 38
    invoke-interface {p2, p3, p1}, Landroid/support/customtabs/b;->updateVisuals(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 16
    .line 17
    invoke-interface {v0, v2, p1, p2, p3}, Landroid/support/customtabs/b;->validateRelationship(Landroid/support/customtabs/a;ILandroid/net/Uri;Landroid/os/Bundle;)Z
