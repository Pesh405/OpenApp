...
.method public final invoke(Lkotlin/jvm/functions/Function0;)Landroidx/compose/ui/Modifier;
    ...
    invoke-direct {v2, p1}, Landroidx/compose/foundation/text/selection/SelectionManager_androidKt$selectionMagnifier$1$2$1;-><init>(Lkotlin/jvm/functions/Function0;)V

    const/4 v3, 0x0

    const/4 v4, 0x0

    new-instance v6, Landroidx/compose/foundation/text/selection/SelectionManager_androidKt$selectionMagnifier$1$2$2;

    iget-object p1, p0, Landroidx/compose/foundation/text/selection/SelectionManager_androidKt$selectionMagnifier$1$2;->$density:Landroidx/compose/ui/unit/Density;

    iget-object v0, p0, Landroidx/compose/foundation/text/selection/SelectionManager_androidKt$selectionMagnifier$1$2;->$magnifierSize$delegate:Landroidx/compose/runtime/MutableState;

    invoke-direct {v6, p1, v0}, Landroidx/compose/foundation/text/selection/SelectionManager_androidKt$selectionMagnifier$1$2$2;-><init>(Landroidx/compose/ui/unit/Density;Landroidx/compose/runtime/MutableState;)V
