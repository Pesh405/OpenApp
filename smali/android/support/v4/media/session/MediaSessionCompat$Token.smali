...
.field private d:Landroid/support/v4/media/session/b;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mLock"
    .end annotation
.end field

.field private f:Landroidx/versionedparcelable/VersionedParcelable;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mLock"
    .end annotation
.end field
...
.method constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/b;Landroidx/versionedparcelable/VersionedParcelable;)V
    .locals 1
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroidx/versionedparcelable/VersionedParcelable;
...
.method public f(Landroid/support/v4/media/session/b;)V
    .locals 1
    .annotation build Landroidx/annotation/RestrictTo;
        value = {
            .enum Landroidx/annotation/RestrictTo$Scope;->LIBRARY:Landroidx/annotation/RestrictTo$Scope;
    ...
    .line 4
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->d:Landroid/support/v4/media/session/b;
...
.method public g(Landroidx/versionedparcelable/VersionedParcelable;)V
    .locals 1
    .annotation build Landroidx/annotation/RestrictTo;
        value = {
    ...
    .line 4
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroidx/versionedparcelable/VersionedParcelable;
